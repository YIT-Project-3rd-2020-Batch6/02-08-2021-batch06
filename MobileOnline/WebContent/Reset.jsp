...
%>
	        <p>New Password</P>
			<input type="Password" name="newpwd" id="pwd1" placeholder="Enter New Password">
			  <p>Confirm New Password</P>
			<input type="Password" name="confirmpwd"  id="pwd2" placeholder="Confirm New Password">
			<input type ="submit" name="reset" value="Reset" onclick="changepwd()">
	  </form>
